 ...
 *
 *  Z-Wave Door/Window Sensor as Light Sensor
 *
 *  Author: SmartThings
 *  Date: 2013-11-3
 *  Modify:  TJM 07-20-2016 - use as light sensor
 */

metadata {
	definition (name: "Z-Wave Door/Window Sensor as Light Sensor", namespace: "smartthings", author: "SmartThings") {
...
/*
'zw device: 09, command: 7105, payload: 07 FF 00 FF 07 FE 00 00 ' to [[name:contact, value:light, descriptionText:My Light Sensor is light, isStateChange:true, displayed:true, linkText:My Light Sensor]]
'zw device: 09, command: 7105, payload: 07 00 00 FF 07 FE 00 00 ' to [[name:contact, value:dark, descriptionText:My Light Sensor is dark, isStateChange:true, displayed:true, linkText:My Light Sensor]]
*/
	...
	simulator {
		// status messages
		status "light":  "command: 2001, payload: FF"
		status "dark": "command: 2001, payload: 00"
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2) {
			state "light", label: '${name}', icon: "st.custom.wu1.sunny" /*, backgroundColor: "#ffa81e"*/
			state "dark", label: '${name}', icon: "st.contact.contact.closed", backgroundColor: "#79b821"
		}
...
def sensorValueEvent(value) {
	if (value) {
		createEvent(name: "contact", value: "light", descriptionText: "$device.displayName is light")
	} else {
		createEvent(name: "contact", value: "dark", descriptionText: "$device.displayName is dark")
	}
}
