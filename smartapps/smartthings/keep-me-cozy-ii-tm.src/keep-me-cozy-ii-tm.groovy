...
private evaluate()
{
	if (sensor) {
        ...
        def curHeatSetPoint = thermostat.heatingSetpoint
        def curCoolSetPoint = thermostat.coolingSetpoint
        def heatOffset = 0
        def coolOffset = 0
		...
		log.debug("evaluate:, mode: $tm -- temp: $ct, heat: $thermostat.currentHeatingSetpoint, cool: $thermostat.currentCoolingSetpoint -- "  +
			"sensor: $currentTemp, heat: $heatingSetpoint, cool: $coolingSetpoint")
